...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role.access:view')->group(function () {
        // Alias route so "/repeats" points to the same index
        Route::get('repeats', [CsRepeatController::class, 'index'])->name('repeats.index');
    ...
    Route::middleware('role.access:view')->group(function () {
        Route::get('maintenances', [CsMaintenanceController::class, 'index'])->name('maintenances.index');
    ...
    Route::middleware('role.access:view')->group(function () {
        ...
        Route::get('transaksis/{transaksi}/lead-history', [TransaksiController::class, 'getLeadHistory'])->name('transaksis.lead-history');
