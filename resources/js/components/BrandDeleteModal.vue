...
import { ref } from 'vue';
import { Trash2, AlertTriangle, Zap } from 'lucide-vue-next';
    ...
    <Dialog :open="open" @update:open="handleClose">
        <DialogContent class="sm:max-w-md">
            <DialogHeader>
                ...
                <DialogDescription>
                    Tindakan ini tidak dapat dibatalkan. Brand akan dihapus secara permanen dari sistem.
                </DialogDescription>
            </DialogHeader>
            ...
            <div v-if="brand" class="py-4">
                <div class="flex items-center gap-4 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                    <div class="flex-shrink-0">
                        ...
                        <div v-else class="w-12 h-12 bg-gradient-to-br from-violet-100 to-purple-100 dark:from-violet-900/30 dark:to-purple-900/30 rounded-lg flex items-center justify-center">
