              ...
              <div class="space-y-2">
                ...
                <input
                  ...
                  :class="{
                    ...
                    'border-gray-300 dark:border-gray-600 focus:border-emerald-500 focus:ring-emerald-200': !form.errors.tanggal
                  }"
                  class="block h-12 w-full rounded-lg border bg-white px-4 text-base text-gray-800 placeholder-gray-500 shadow-sm transition-all duration-200 hover:border-emerald-300 focus:outline-none focus:ring-2 focus:ring-opacity-50 dark:bg-gray-700 dark:text-white"
                  required
                />
