            ...
            <div class="w-full max-w-md">
                ...
                <div class="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl">
                    ...
                    <div class="text-center mb-6">
                        <h2 class="text-xl font-semibold text-white mb-2">Buat Akun Baru</h2>
                        <p class="text-white/70 text-sm">Lengkapi form dibawah untuk membuat akun</p>
                    </div>
                    ...
                    >
                        <!-- Name Field -->
                        <div class="space-y-2">
                            <Label for="name" class="text-white/90 font-medium">Nama Lengkap</Label>
                            <Input
                                id="name"
                                type="text"
                                name="name"
                            ...
                            />
                            <InputError :message="errors.name" class="text-red-200" />
                        </div>
                        ...
                        <div class="space-y-2">
                            <Label for="password_confirmation" class="text-white/90 font-medium">Konfirmasi Password</Label>
                            <Input
                        ...
                        <Button 
                            type="submit" 
                            class="w-full h-12 bg-white/20 backdrop-blur-md hover:bg-white/30 text-white font-medium border border-white/30 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 mt-6" 
                            :tabindex="5" 
                            :disabled="processing"
                        >
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-white/70 text-sm">
                            Sudah punya akun?
                            <TextLink :href="login()" class="text-white hover:text-orange-200 font-medium ml-1 transition-colors" :tabindex="6">
                                Masuk disini
                            </TextLink>
                        </p>
                    </div>
